...
#revised paw.py
python paw_revised.py -r ../2.testGuangzheDNaseBRG1KO/1.raw/CTCF.bed -t ../2.testGuangzheDNaseBRG1KO/1.raw/DP_BRG1_KO.bw -c ../2.testGuangzheDNaseBRG1KO/1.raw/DP_BRG1_WT.bw -o test3/BRG1 -p 20 -csf ~/caoy7/Projects/0.Reference/2.mm10/1.fa/mm10.chrom.sizes.main -lt KO -lc WT 
