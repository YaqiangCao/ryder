...
#python patrol_revised.py -r ../2.testGuangzheDNaseBRG1KO/1.raw/CTCF.bed -c ../2.testGuangzheDNaseBRG1KO/1.raw/DP_BRG1_WT.bw -t test3/BRG1_KO.bw -o test3/BRG1_CTCF -lc WT -lt BRG1KO -pcut 0.01
python patrol_revised.py -r ../2.testGuangzheDNaseBRG1KO/1.raw/DP_BRG1_peaks.bed -c ../2.testGuangzheDNaseBRG1KO/1.raw/DP_BRG1_WT.bw -t test3/BRG1_KO.bw -o test3/BRG1_BRG1 -lc WT -lt BRG1KO -pcut 0.01
