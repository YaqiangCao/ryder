...
python patrol.py -r ../2.testGuangzheDNaseBRG1KO/1.raw/DP_BRG1_peaks.bed -c ../2.testGuangzheDNaseBRG1KO/1.raw/DP_BRG1_WT.bw -t test3/BRG1_KO.bw -o test3/BRG1_BRG1 -lc WT -lt BRG1KO -mode FC
