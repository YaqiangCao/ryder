...
python patrol.py -r ../2.testGuangzheDNaseBRG1KO/1.raw/DP_BRG1_peaks.bed -c ../2.testGuangzheDNaseBRG1KO/1.raw/DP_BRG1_WT.bw -t test/BRG1_KO.bw -o test/BRG1_diff -lc WT -lt BRG1KO -pcut 0.05
