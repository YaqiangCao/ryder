...
python patrol.py -r ../2.testGuangzheDNaseBRG1KO/1.raw/CTCF.bed -c ../2.testGuangzheDNaseBRG1KO/1.raw/DP_BRG1_WT.bw -t test4/BRG1_KO.bw -o test4/BRG1_CTCF -lc WT -lt BRG1KO &
python patrol.py -r ../2.testGuangzheDNaseBRG1KO/1.raw/CTCF.bed -c ../2.testGuangzheDNaseBRG1KO/1.raw/DP_BRG1_WT.bw -t test4/BRG1_KO.bw -o test4/BRG1_CTCF_FC -mode FC -lc WT -lt BRG1KO &
python patrol.py -r ../2.testGuangzheDNaseBRG1KO/1.raw/DP_BRG1_peaks.bed -c ../2.testGuangzheDNaseBRG1KO/1.raw/DP_BRG1_WT.bw -t test4/BRG1_KO.bw -o test4/BRG1_BRG1 -lc WT -lt BRG1KO  &
python patrol.py -r ../2.testGuangzheDNaseBRG1KO/1.raw/DP_BRG1_peaks.bed -c ../2.testGuangzheDNaseBRG1KO/1.raw/DP_BRG1_WT.bw -t test4/BRG1_KO.bw -o test4/BRG1_BRG1 -lc WT -lt BRG1KO -mode FC -pcut 0.01 &
